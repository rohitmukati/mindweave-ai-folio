...
const projects = [
  {
    ...
    description:
      "AI-Optimized B2B lead generation platform using FastAPI, Streamlit, and SerpAPI with autonomous search agents and real-time data pipelines.",
    ...
    github: "https://github.com/rohitmukati/Agentic-Search_Platform",
    demo: "#",
    icon: Search,
  },
  {
    ...
    description:
      "End-to-end hiring automation that streamlines resume collection, parsing, analysis, and evaluation with intelligent candidate matching.",
    image: "/placeholder.svg",
    technologies: [
      "Gmail API",
      "Google Drive API",
    ...
    github: "https://github.com/rohitmukati/Automate-Hiring-Process",
    demo: "#",
    icon: Bot,
  },
  {
    ...
    description:
      "AI-powered medical chatbot utilizing LangChain and RAG pipeline for accurate healthcare responses with 700+ pages of medical knowledge.",
    image: "/placeholder.svg",
    ...
    github: "https://github.com/rohitmukati/End-to-End-Medical-Chatbot-Generative-AI",
    demo: "#",
    icon: Brain,
  },
  {
    ...
    description:
      "End-to-end text summarization system with structured pipeline using Hugging Face Samsum dataset and transformer fine-tuning.",
    image: "/placeholder.svg",
    ...
    github: "https://github.com/rohitmukati/Text-Summarization-NLP",
    demo: "#",
    icon: FileText,
  },
];
