...
const ContactSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await fetch("http://localhost:3001/api/save-message", {
      method: "POST",
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full h-10 px-3 rounded-md glass-card border border-glass-border focus:border-primary transition-colors bg-background text-foreground"
                  >
